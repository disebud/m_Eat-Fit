...
class TransactionRepository(val transactionAPI: TransactionAPI) {
    ...
    var transactionTopUpListLiveData = MutableLiveData<List<TransactionWallet>>()
//    var amountLiveData = MutableLiveData<Amount>()
    ...
    fun TransactionTopUpList(id:String){
        transactionAPI.TransactionTopUpList(id).enqueue(object : Callback<List<TransactionWallet>>{
            override fun onResponse(call: Call<List<TransactionWallet>>, response: Response<List<TransactionWallet>>) {
                transactionTopUpListLiveData.value = response.body()
            }
